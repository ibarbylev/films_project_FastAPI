...
Простейший [FastAPI](https://fastapi.tiangolo.com/) проект, реализующий:
...
* поиск фильмов по 
  ...
  * жанрам
  * году выпуска
  * жанрам и году выпуска

Проект демонстрирует работу с JSON-данными и динамическим рендерингом HTML с помощью шаблонизатора [Jinja2](https://jinja.palletsprojects.com/en/stable/).

Для стилизации проекта использован [Bootstrap](https://getbootstrap.com/docs/5.3/getting-started/introduction/)
